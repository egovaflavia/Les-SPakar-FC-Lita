		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					...
					<li class="nav-item">
						<a class="nav-link" href="penyakit.php"><span class="fa icon-bug"></span> Penyakit</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="gejala.php"><span class="fa icon-stethoscope"></span> Gejala</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="solusi.php"><span class="fa icon-gittip "></span> Penanganan</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="user.php"><span class="fa fa-users"></span> User</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="laporan.php"><span class="fa icon-book"></span> Laporan</a>
					</li>
					<!-- <li class="nav-item">
